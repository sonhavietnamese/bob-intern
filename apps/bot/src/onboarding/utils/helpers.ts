...
export async function updateExpertiseMessage(ctx: OnboardingContext) {
  ...
  try {
    ...
    try {
      await ctx.editMessageText(`What is your expertise?`, {
        reply_markup: {
          inline_keyboard: inlineKeyboard,
        },
      })
...
export async function updateListingMessage(ctx: OnboardingContext) {
  ...
  try {
    ...
    try {
      await ctx.editMessageText(`Superteam Earn comes with Bounties and Projects, which you most prefer?`, {
        reply_markup: {
          inline_keyboard: inlineKeyboard,
        },
      })
...
export async function showExpertiseSelection(ctx: OnboardingContext) {
  ...
  try {
    await ctx.replyWithPhoto('https://bob-intern-cdn.vercel.app/expertise.png', {
      caption: `What is your expertise?`,
      reply_markup: {
        inline_keyboard: inlineKeyboard,
      },
